...
for file in files:
	...
	subprocess.call(
		f'python objmc.py --objs "D:/github-repos/mcmap-plush-rush/objmodels/{file["name"]}.obj" --texs "{file["texture"]}" --out "{file["output"]}.json" "block/objmc/{file["output"]}.png" --offset {offset[0]} {offset[1]} {offset[2]} --scale {file["scale"]} --duration 20 --easing 3 --colorbehavior ttt --autorotate 0'
	)
